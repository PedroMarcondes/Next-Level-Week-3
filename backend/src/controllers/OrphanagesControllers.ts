...
export default {
  ...
  async create(request: Request, response: Response){
    ...
    const schema = Yup.object().shape({
      ...
      opening_hours: Yup.string().required('Horário das visitas é um campo obrigatório'),
      open_on_weekends: Yup.boolean().required('Atende nos fins de semana é um campo obrigatório'),
      images: Yup.array(
        Yup.object().shape({
